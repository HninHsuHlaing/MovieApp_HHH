...
import kotlinx.android.synthetic.main.criminal_fragment.*
...
class CriminalFragment:Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.criminal_fragment,container,false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        rcCriminalFragment.layoutManager = layoutManager1
        rcCriminalFragment.adapter = mAdapter
    }
}